...
def display_Play():
  ...
  choosed = input()
  match choosed :
        case "1" : print("please input your message : "); message= input(); print("please input the key"); key= input() ; cipher=playfair(key, message); print(cipher)
        case "2" : print("please input your message : "); message= input(); print("please input the key"); key= input() ; plain=playfair(key, message, False); print(plain)
